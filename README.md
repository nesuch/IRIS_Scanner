...
## Troubleshooting: `ModuleNotFoundError: No module named 'flask_migrate'`

If you see this exact error while running `python app.py`, your local checkout is not on the latest migration refactor.

1. Verify there is **no** `from flask_migrate import Migrate` in `app.py`.
2. Update your branch and reinstall deps:
...
3. Run migrations (Alembic-based):
