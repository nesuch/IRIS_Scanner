...
# Ensure single initialization to prevent SQLAlchemy metadata conflicts.
db = SQLAlchemy(app)
...
@login_required
def home():
    # After login, land users on the IRIS module UI instead of a plain text page.
    return render_template("index.html", active_module="universal")
